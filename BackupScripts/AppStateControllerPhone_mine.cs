...
public class AppStateControllerPhone : MonoBehaviour
{
    ...
    public void StartGraffiti()
    {
        ...
        {
            // This will call painter.StartPainting() inside SetPhase(Phase.Painting)
            SetPhase(Phase.Painting);
        }
        else
        {
            // Optional: helpful debug message
            Debug.LogWarning($"StartGraffiti() called in phase {_phase}, but expected Phase.PlaneSelected.");
        }
    }
    ...
    public void StopGraffiti()
    {
        ...
        {
            // In your ToggleGraffiti, you stop the painter explicitly before going back.
            painter.StopPainting();
            SetPhase(Phase.PlaneSelected);
        }
        else
        {
            // Optional: helpful debug message
            Debug.LogWarning($"StopGraffiti() called in phase {_phase}, but expected Phase.Painting.");
        }
    }
