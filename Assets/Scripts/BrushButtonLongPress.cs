...
/// <summary>
/// Handles long press events and scaling animations for Brush button.
/// Long press to start graffiti with square shape, release to stop graffiti.
/// </summary>
public class BrushButtonLongPress : MonoBehaviour
{
    [Header("Settings")]
    ...
    void OnPointerDown(PointerEventData eventData)
    {
        ...
        {
            Debug.LogWarning("BrushButtonLongPress: Button is not interactable!");
            return;
        }
    ...
    IEnumerator LongPressDetection()
    {
        ...
        {
            Debug.LogWarning("BrushButtonLongPress: Long press detected but AppStateControllerPhone is null!");
        }
    }
